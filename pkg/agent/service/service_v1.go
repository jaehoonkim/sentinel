...
// func ConvertServiceListManagerToAgent(manager []servicev3.HttpRsp_AgentServicePolling) map[string]*ServiceV1 {
// 	agent := make(map[string]*ServiceV1)
...
// func ConvertServiceStepUpdateAgentToManager(client UpdateServiceV1) *servicev3.HttpReq_AgentServiceUpdate {
// 	manager := &servicev3.HttpReq_AgentServiceUpdate{
// 		Uuid:     client.Uuid,
...
// 		manager.Status = servicev3.StepStatusProcessing
// 	case StepStatusSuccess:
// 		manager.Status = servicev3.StepStatusSuccess
// 	case StepStatusFail:
// 		manager.Status = servicev3.StepStatusFail
// 	}
