...
const sudoryAuthTokenHeaderName = "x-sudory-agent-token"
...
func (s *SudoryAPI) GetServices(ctx context.Context) ([]servicev4.HttpRsp_AgentServicePolling, error) {
...
func (s *SudoryAPI) UpdateServices(ctx context.Context, service *servicev4.HttpReq_AgentServiceUpdate) error {
	if service == nil {
