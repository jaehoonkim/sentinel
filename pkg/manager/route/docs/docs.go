...
const docTemplate = `{
    ...
    "info": {
        ...
        "title": "{{.Title}}",
        "contact": {
            "url": "https://github.com/jaehoonkim/sentinel",
    ...
    "paths": {
        ...
        "/agent/service": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "HttpReq_AgentServiceUpdate",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.HttpReq_AgentServiceUpdate"
                        }
                    }
                ],
                "responses": {
        ...
        "/manager/channels": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "query  github.com/jaehoonkim/sentinel/pkg/manager/database/vanilla/stmt/README.md",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "order  github.com/jaehoonkim/sentinel/pkg/manager/database/vanilla/stmt/README.md",
                        "name": "o",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "paging github.com/jaehoonkim/sentinel/pkg/manager/database/vanilla/stmt/README.md",
                        "name": "p",
                        "in": "query"
                    }
                ],
        ...
        "/manager/channels/{uuid}/notifiers/console": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/notifiers/edge": {
            "get": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/notifiers/rabbitmq": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/notifiers/slackhook": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/notifiers/webhook": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/status/option": {
            "get": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/channels/{uuid}/status/purge": {
            "delete": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/cluster/{uuid}/polling/regular": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/cluster/{uuid}/polling/smart": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/cluster_token/{uuid}/expire": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/cluster_token/{uuid}/label": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/cluster_token/{uuid}/refresh": {
            "put": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/service/{uuid}/step/{sequence}": {
            "get": {
                "security": [
                    {
                        "ServiceAuth": []
        ...
        "/manager/session/cluster/{cluster_uuid}/alive": {
            "get": {
                "security": [
                    {
                        "ServiceAuth": []
    ...
    "definitions": {
        ...
        "service.HttpReq_AgentServiceUpdate": {
            "type": "object",
            "properties": {
                "version": {
                    "type": "string"
