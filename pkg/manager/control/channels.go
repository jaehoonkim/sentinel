...
// @Accept      json
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels [post]
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid} [get]
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid} [put]
// @Param       uuid         path   string                           true  "Channel 의 Uuid"
...
// @Produce json
// @Tags manager/channels
// @Router /manager/channels/{uuid} [delete]
// @Param       uuid         path   string true  "Channel 의 Uuid"
// @Success 200
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/notifiers/edge [get]
// @Param       uuid         path   string true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/status/option [get]
// @Param       uuid         path   string true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/notifiers/console [put]
// @Param       uuid         path   string                         true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/notifiers/rabbitmq [put]
// @Param       uuid         path   string                                            true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/notifiers/webhook [put]
// @Param       uuid         path   string                                           true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/notifiers/slackhook [put]
// @Param       uuid         path   string                                             true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/format [get]
// @Param       uuid         path   string true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/format [put]
// @Param       uuid         path   string                                  true  "Channel 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/status/option [put]
// @Param       uuid         path   string                                               true  "Channel 의 Uuid"
...
// @@Produce     json
// @@Tags        manager/channels
// @@Router      /manager/channels/{uuid}/status [post]
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/status [get]
// @Param       uuid  path  string                                   true  "channel status 의 Uuid"
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/{uuid}/status/purge [delete]
// @Param       uuid         path   string true  "channel status 의 Uuid"
// @Success 200
...
// @Produce     json
// @Tags        manager/channels
// @Router      /manager/channels/status [get]
// @Param       q            query  string false "query  github.com/NexClipper/sudory/pkg/manager/database/vanilla/stmt/README.md"
// @Param       o            query  string false "order  github.com/NexClipper/sudory/pkg/manager/database/vanilla/stmt/README.md"
// @Param       p            query  string false "paging github.com/NexClipper/sudory/pkg/manager/database/vanilla/stmt/README.md"
// @Success     200 {array} v3.HttpRsp_ManagedChannel_ChannelStatus
