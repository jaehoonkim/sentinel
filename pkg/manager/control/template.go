...
// @Router      /manager/template/{uuid} [get]
...
// @Accept      json
// @Produce     json
// @Tags        manager/template_command
// @Router      /manager/template_command [get]
...
// @Produce     json
// @Tags        manager/template_command
// @Router      /manager/template_command/{uuid} [get]
