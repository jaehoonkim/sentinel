...
// @Router      /manager/cluster_token [post]
...
// @Produce     json
// @Tags        manager/cluster_token
// @Router      /manager/cluster_token/{uuid} [get]
...
// @Produce     json
// @Tags        manager/cluster_token
// @Router		/manager/cluster_token/{uuid}/label [put]
// @Param       uuid         path   string                         true  "ClusterToken Uuid"
...
// @Produce     json
// @Tags        manager/cluster_token
// @Router      /manager/cluster_token/{uuid}/refresh [put]
// @Param       uuid         path   string true  "ClusterToken Uuid"
// @Success     200 {object} cluster_token.HttpRsp_ClusterToken
...
// @Produce     json
// @Tags        manager/cluster_token
// @Router      /manager/cluster_token/{uuid}/expire [put]
// @Param       uuid         path   string true  "ClusterToken Uuid"
// @Success     200 {object} cluster_token.HttpRsp_ClusterToken
...
// @Produce     json
// @Tags        manager/cluster_token
// @Router      /manager/cluster_token/{uuid} [delete]
// @Param       uuid         path   string true  "ClusterToken Uuid"
// @Success     200
