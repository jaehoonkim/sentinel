...
// @Produce     json
// @Tags        manager/cluster
// @Router      /manager/cluster/{uuid} [get]
...
// @Produce     json
// @Tags        manager/cluster
// @Router      /manager/cluster/{uuid} [put]
// @Param       uuid         path   string                    true  "Cluster Uuid"
...
// @Produce     json
// @Tags        manager/cluster
// @Router      /manager/cluster/{uuid}/polling/regular [put]
// @Param       uuid           path   string                  true  "Cluster Uuid"
...
// @Produce     json
// @Tags        manager/cluster
// @Router      /manager/cluster/{uuid}/polling/smart [put]
// @Param       uuid           path   string                true  "Cluster Uuid"
...
// @Produce json
// @Tags manager/cluster
// @Router /manager/cluster/{uuid} [delete]
// @Param       uuid         path   string true  "Cluster Uuid"
// @Success 200
