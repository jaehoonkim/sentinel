...
func TestPollingV3(t *testing.T) {
	...
	var v3_polling = v3.HttpRsp_AgentServicePolling{}
	...
	var polling HttpRsp_AgentServicePolling
...
func TestPollingV4(t *testing.T) {
	...
	var v4_polling = HttpRsp_AgentServicePolling_multistep{Name: "v4service"}
